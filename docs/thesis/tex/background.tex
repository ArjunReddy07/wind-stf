...
\begin{figure}
\centering
\includegraphics{/home/jonasmmiguel/.config/Typora/typora-user-images/image-20200617060458953.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{https://www.researchgate.net/profile/Marcelo_Molina/publication/221911675/figure/fig2/AS:304715268149248@1449661189252/General-description-of-a-wind-turbine-system-The-appropriate-voltage-level-is-related-to.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{https://otexts.com/fpp2/fpp_files/figure-html/traintest-1.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{https://otexts.com/fpp2/fpp_files/figure-html/cv1-1.png}
\caption{}
\end{figure}
...
\begin{longtable}[]{@{}llll@{}}
\toprule
alias & name & scale \textless br /\textgreater{}sensitivity &
OUTLIERS\textless br /\textgreater{}SENSITIVITY\tabularnewline
\midrule
\endhead
RMSE & Root Mean Squared Error & \(\circle\) &
\(\circle \circle\)\tabularnewline
MAE & Mean Absolute Error & \(\circle\) & \(\circle\)\tabularnewline
MASE & Mean Absolute Scaled Error & o & \(\circle\)\tabularnewline
MAPE & Mean Absolute Percentual Error & o & \(\circle\)\tabularnewline
MdAPE & Median Absolute Percentual Error & o & o\tabularnewline
sMAPE & Symmetric Mean Absolute Percentual Error & o & o\tabularnewline
sMdAPE & Symmetric Median Absolute Percentual Error & o &
o\tabularnewline
MdRAE & Median Relative Absolute Error & o & o\tabularnewline
\bottomrule
\end{longtable}

Table ???. Forecasting accuracy metrics and their sensitivities to scale
and outliers.

By summarizing the forecast error distribution into a reduced set of
values, forecasting metrics are essential in model development as well
as in method development. To forecasters (model developers) and forecast
users, metrics offer a concise, unambiguous way to communicate accuracy
requirements and specifications. For methods developers, it allows
comparing different methods across different use cases, forecasting
settings, and datasets.

On the one hand, single metrics concisely convey information about the
error distribution, which is useful for comparing models and making
decisions. On the other hand, a single metric cannot convey all aspects
of the error distribution, and often using more than one metric becomes
necessary to ensure sufficiency
(\textbackslash cite\{armstrong2002principles\}). Therefore, deciding on
a group of metrics often involves a trade-off between conciseness and
sufficiency.
...
\textbf{\includegraphics{/home/jonasmmiguel/Desktop/methods-overview.png}}Fig.
...
\begin{figure}
\centering
\includegraphics{http://colah.github.io/posts/2015-08-Understanding-LSTMs/img/LSTM3-SimpleRNN.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{/home/jonasmmiguel/.config/Typora/typora-user-images/image-20200616201550854.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{/home/jonasmmiguel/.config/Typora/typora-user-images/image-20200616234156789.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{/home/jonasmmiguel/.config/Typora/typora-user-images/image-20200616235706340.png}
\caption{}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{/home/jonasmmiguel/.config/Typora/typora-user-images/image-20200617004620751.png}
\caption{}
\end{figure}
